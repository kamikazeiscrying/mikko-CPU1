...
//  output [`DATA_BUS]      debug_ram_read_data
);
  ...
  assign debug_hi_read_data = to_hi_write_data;
  assign debug_lo_read_data = to_lo_write_data;
  assign debug_ifid_inst = rom_read_data;
//  assign debug_ram_read_data = ram_write_data;
